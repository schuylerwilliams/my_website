...
function cityButtonTwoClicked(x) {
	...
	clickedButtonTwo.style.backgroundColor = "#008CBA";
...
function cityButtonOneClicked(x) {
	...
	clickedButtonOne.style.backgroundColor = "#008CBA";
...
function cityButtonMouseOverTwo(x) {
	...
	map.setPaintProperty(antipodeMouseButtonTwo, 'circle-color', "#008CBA");
...
function cityButtonMouseOverOne(x) {
	...
	map.setPaintProperty(antipodeMouseButtonOne, 'circle-color', "#008CBA");
...
function initiateAnimation() {
	if (hoverAnimationControl == false) {
		myTimer = setInterval(startAnimation, 1000);
